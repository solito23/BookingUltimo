    ...
    <body>
        ...
        <%
            ...
            if (request.getAttribute("productos") != null) {
                ...
                ArrayList<personasDTO> productos =(ArrayList<personasDTO>) request.getAttribute("productos");
                
                if (productos.size() == 0) {
        %>
        <div class="row text-right">
            <div class="valido1"><h1>Ningun registro</h1></div>
        ...
        <%            for (personasDTO producto : productos) {
